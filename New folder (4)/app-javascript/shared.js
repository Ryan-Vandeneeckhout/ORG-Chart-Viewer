...
document.addEventListener('DOMContentLoaded', () => {
  ...
  try {
    ...
    if (last && last !== current) {
      sessionStorage.setItem('cgp:previousPage', last);
    }
 ...
 * <header
 *   data-cgp-header
 *   data-tagline="PDF Form Filler · v3.3"
 *   data-hide-back="true"
...
<header class="cgp-header">
  <div class="header-inner">
    <div class="logo-mark cgp-logo-mark">
      <svg
        class="cgp-logo-icon"
        width="30"
        height="30"
        ...
        fill="none"
        data-nav="index.html"
        aria-label="CommandGridPro home"
      >
    ...
    <div class="cgp-header-actions">
      ...
      <button
        class="cgp-header-btn cgp-settings-btn"
        id="cgp-settings-btn"
        type="button"
        data-nav="settings.html"
        title="Settings"
        aria-label="Settings"
      >
      ...
      <button
        class="cgp-header-btn cgp-back-btn"
        id="cgp-back-btn"
        type="button"
...
<span id="cgp-footer-version">v1.0.0</span>`;
  ...
  function wireHeaderEvents(container) {
    ...
    container.querySelectorAll('[data-nav]').forEach(el => {
      ...
      if (el.classList.contains('cgp-brand')) {
    ...
    if (backBtn) {
      backBtn.addEventListener('click', () => {
        goBack(backBtn.getAttribute('data-back') || 'index.html');
      });
    }
  }
